// Copyright 2009 The Go Authors and 2021 SUSE LLC. All rights reserved.
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.

// HTTP file system request handler. This was initially coppied from the Go
// source and updated for additional log handling.
...
func dirList(w http.ResponseWriter, r *http.Request, f http.File) {
	...
	if err != nil {
		log.Errorf("http: error reading directory: %v", err)
